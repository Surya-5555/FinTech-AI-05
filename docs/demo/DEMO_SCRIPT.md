...
journey
    ...
    section Simulated Failure (2:30 - 4:00)
...
3. **Simulated Failure (2:30–4:00):** Induce a DB lock, observe graceful timeout handling, show clean state machine abort in logs, verify audit trail captures the failure.
