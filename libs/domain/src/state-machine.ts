...
const validTransitions: Record<RevenueCaseState, Set<RevenueCaseState>> = {
  ...
  [RevenueCaseState.EXECUTING]: new Set([RevenueCaseState.RECOVERED, RevenueCaseState.FAILED, RevenueCaseState.RETRYABLE, RevenueCaseState.ESCALATED, RevenueCaseState.STOPPED, RevenueCaseState.AWAITING_CUSTOMER_ACTION]),
